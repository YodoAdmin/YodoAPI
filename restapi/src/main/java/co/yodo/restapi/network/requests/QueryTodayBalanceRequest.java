 ...
 * Request the merchant today balance from the server
 */
public final class QueryTodayBalanceRequest extends QueryRequest {
    /** Query request record */
    private static final String RECORD_TODAY = "12";

    public QueryTodayBalanceRequest(String pip) {
        formattedData = identifier + REQ_SEP + pip + REQ_SEP + RECORD_TODAY;
    }
